...
<template>
    <div class="md:flex justify-center mx-auto md:space-x-10 p-2 -mt-28  md:-mt-32 md:w-2/3 w-11/12 rounded-xl">
        <div class="text md:p-5">
            ...
            <p class="p-6 text-sm">Praesent ultrices, sapien sit amet pharetra blandit, nibh nisi auctor tellus, at mollis
                ...
                molestie ultrices. Aenean ultrices elementum lorem vel porta. Integer magna elit Praesent porta eros nec
                ipsum commodo porttitor. Sed
                sit amet lacinia erat. Nulla facilisi.
                Vestibulum pellentesque malesuada tincidunt. In hac habitasse platea dictumst. Curabitur
                rutrum
                cursus
        ...
        <div class="img md:m-20 md:p-5 p-5 text-sm"><img class="rounded-t-full" width="2400" height="100%"
